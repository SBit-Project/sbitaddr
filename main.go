...
const (
	sbitMainPubKeyHashAddrID = 63
	sbitMainScriptHashAddrID = 50

	sbitTestNetPubKeyHashAddrID = 125
	sbitTestNetScriptHashAddrID = 110
)
...
func run() error {
	...
	var version byte = sbitMainPubKeyHashAddrID
	if *flagIsTestnet {
		version = sbitTestNetPubKeyHashAddrID
	}
